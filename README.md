...
**Tech used:** HTML, TailwindCSS JavaScript, Go, Fiber, Gorm, SQLite, Postman

I took an old project that i amde to learn Go as a backend and actually made the front end UI usable. I had made the UI seperately with TailwindCSS and then used Javascript to connect the front and back end.

I also used JS to populate new customer cards. However using vanilla JS to populate TailwindCSS styling doesnt work how i have it set up. the next step is using react and then using tailwindcss styled components.
